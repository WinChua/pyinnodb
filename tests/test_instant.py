...
def test_parse_mysql8_instant(mysqlfile: MysqlFile):
    ...
    r1 = cls(id=1, name='original record', drop2='original drop 2 column', add1=None, add2='add2 default', drop1=99)
    r2 = cls(id=2, name='insert after alter', drop2='drop2 after alter', add1=None, add2='add2', drop1=99)
    assert len(result) == 2
    assert r1 == result[0]
    assert r2 == result[1]
